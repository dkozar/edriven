...
... and many other. They all serve to the purpose of the framework: making a decoupled programming possible with Unity. 

h2. Resources

* "eDriven API":http://edriven.dankokozar.com/api/1-0/ (note: eDriven.Gui and eDriven.Animation APIs also included)
